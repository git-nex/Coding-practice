...
int32_t main()
{
    ...
    for(k=0;k<t;k++)
    {
        ll n,m,i,j,count=0,x,ans=0,c1=0,c2=0,y,sol=0,res=0;
        bool flag=true;
        vll a;
        string s;
        read(s);
        ...
        fo(i,0,n,1)
        {
          ...
          else if(s[i]=='1' and s[i-1]=='?')
          {
            ...
            else if(s[last]=='0' and count%2==0)
            {
              ans=ans+count+1;
            }
            else if(s[last]=='1' and count%2==1)
            {
              ans=ans+count;
            }
            else
        ...
        if(s[i]=='0' and s[i-1]=='1')
          ...
          else if(s[i]=='0' and s[i-1]=='?')
          {
            ...
            else if(s[last]=='1' and count%2==0)
            {
              ans=ans+count+1;
            }
            else if(s[last]=='0' and count%2==1)
            {
              ans=ans+count;
            }
            else
